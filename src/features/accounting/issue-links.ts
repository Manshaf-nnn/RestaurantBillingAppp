...
export function issueAdvice(checkKey: string): string {
  const advice: Record<string, string> = {
    ...
    'paid-over-billed': 'A bill holds more money than it charged. Open the order and refund the overpayment, or correct the bill.',
    'loyalty-earned-once': 'A bill earned loyalty points more than once. Open the order and remove the duplicate earning; the balance needs a hand correction.',
